...
public:
    ...
    int Extend(const Eigen::Matrix<float, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor> &extended);
...
private:
    ...
    Eigen::VectorXf m_mean_vector;  // internal mean value used for centering
    Eigen::VectorXf m_sd_vector;   // internal sd value used for normalising
