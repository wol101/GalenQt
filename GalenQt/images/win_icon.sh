...
cp -f resized_icons/icon256x256.png ../Icon.iconset/icon_128x128@2x.png
cp -f resized_icons/icon128x128.png ../Icon.iconset/icon_128x128.png
cp -f resized_icons/icon32x32.png ../Icon.iconset/icon_16x16@2x.png
cp -f resized_icons/icon16x16.png ../Icon.iconset/icon_16x16.png
cp -f resized_icons/icon512x512.png ../Icon.iconset/icon_256x256@2x.png
cp -f resized_icons/icon256x256.png ../Icon.iconset/icon_256x256.png
cp -f resized_icons/icon64x64.png ../Icon.iconset/icon_32x32@2x.png
cp -f resized_icons/icon32x32.png ../Icon.iconset/icon_32x32.png
cp -f resized_icons/icon512x512.png ../Icon.iconset/icon_512x512@2x.png
cp -f resized_icons/icon1024x1024.png ../Icon.iconset/icon_512x512.png
